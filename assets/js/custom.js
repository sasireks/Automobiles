...
jQuery(function($){
	...
	$("#back-to-signin").on('click', function(e){
		$('#login-content').show();
		$('#signup-content').hide();
	...
	$("#admindialogmodal").on('click', function(e){
		$('#adminlogin-form').show();
		e.preventDefault();		
	});

	$("#adminsignup-btn").on('click', function(e){
		$('#adminsignup-content').show();
		$('#adminlogin-content').hide();
		e.preventDefault();		
	});

	$("#adminlogin-btn").on('click', function(e){
		$('#adminlogin-content').show();
		$('#adminsignup-content').hide();
		e.preventDefault();
				
	});
	$("#adminback-to-signin").on('click', function(e){
		$('#adminlogin-content').show();
		$('#adminsignup-content').hide();
